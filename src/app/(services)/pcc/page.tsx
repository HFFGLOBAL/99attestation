...
import { ShieldCheckIcon, CheckBadgeIcon, GlobeAltIcon, ClockIcon, UserGroupIcon, IdentificationIcon } from '@heroicons/react/24/solid';
import { FaRegSmile, FaUserShield, FaGlobeAsia } from 'react-icons/fa';
    ...
    <>
      ...
      <section className="hero-section bg-cream rounded-none shadow-none mb-8 flex flex-col items-center justify-center p-8 w-full" style={{borderRadius: 0, boxShadow: 'none', marginLeft: 0, marginRight: 0, maxWidth: '100vw'}}>
        ...
        <div className="flex flex-col md:flex-row justify-center gap-4 mt-6">
          <a href="https://wa.me/919686924808?text=Hello%2C%20I%20need%20expert%20advice%20on%20PCC%20attestation." target="_blank" rel="noopener noreferrer" className="inline-block bg-orange text-navy font-bold-custom px-8 py-3 rounded-full shadow hover:bg-yellow transition hover-scale">Talk to Expert</a>
      ...
      <section className="why-choose-section bg-yellow/20 rounded-xl p-6 mb-8">
        ...
        <ul className="usp-list grid grid-cols-1 md:grid-cols-2 gap-4">
          <li className="flex items-center gap-3"><ShieldCheckIcon className="w-7 h-7 text-orange" /> Govt. Approved</li>
          <li className="flex items-center gap-3"><FaUserShield className="w-7 h-7 text-orange" /> Fast Processing</li>
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          <div className="bg-cream rounded-xl shadow p-6 flex flex-col items-center">
            <FaUserShield className="w-10 h-10 text-orange mb-2" />
            <p className="italic text-navy mb-2">“PCC attestation was completed quickly and securely. Highly professional!”</p>
            <span className="font-bold-custom text-navy">Sunil K.</span>
          </div>
          <div className="bg-cream rounded-xl shadow p-6 flex flex-col items-center">
            ...
            <span className="font-bold-custom text-navy">Meena S.</span>
          </div>
          <div className="bg-cream rounded-xl shadow p-6 flex flex-col items-center">
      ...
      <section className="cta-section" style={{textAlign: 'center', margin: '3rem 0'}}>
        <a
          href="https://wa.me/919686924808?text=Hello%2C%20I%20need%20expert%20advice%20on%20PCC%20attestation."
          target="_blank"
